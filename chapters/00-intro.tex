...
One such discrepancy was found when comparing the performance of Weka and scikit-learn on an activity dataset~\cite{problematic_dataset}. The difference between classification accuracies in this case was considerable at about 25\% in favor of Weka.
