...
\begin{center}
    \begin{tikzpicture}
        ...
        \node [boxed] {ColourRed $\leqslant 0.5$?}
            child { node [boxed] {ColourGreen $\leqslant 0.5$?}
...
%TODO observation weights to split observations with missing values
